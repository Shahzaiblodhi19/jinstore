...
const slides = [
  {
    id: 1,
    image: Banner1, // update with actual file names
            ...
            {slides.map((slide, idx) => (
              ...
              >
                ...
                <div className="w-full px-4 sm:px-8 md:px-12">
                  ...
                  <p className="text-[#030712] text-sm md:text-[12px] mt-2 md:w-[80%] lg:w-[55%]">
                    {slide.description}
                  </p>

                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-6 sm:mt-7">
                    <button className="bg-[#634C9F] hover:bg-purple-700 transition-all cursor-pointer text-white text-sm px-5 py-2.5 rounded-md flex items-center gap-3">
                      Shop Now{" "}
                      <svg
                    ...
                    <div>
                      <div className="flex items-center mt-1 sm:mt-0">
                        <p
                          className="text-[#DC2626] font-bold text-lg sm:text-[20px] md:text-[24px] flex items-end"
                          id="price"
                        >
                          {slide.price}
                        </p>
                        <span
                          className="line-through text-[#111827] text-sm md:text-[16px] font-medium ml-2"
                          id="price"
                        >
                          {slide.original}
                        </span>
