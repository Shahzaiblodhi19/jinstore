  ...
  return (
    ...
    >
      ...
      <div ref={headingRef} className="flex items-center gap-3 flex-wrap">
        <h2 className="text-[18px] font-bold text-[#030712]">New Arrivals</h2>
      ...
      <button
        ref={buttonRef}
        className="text-[12px] cursor-pointer font-semibold text-[#000] border border-[#E5E7EB] rounded-full px-4 py-2 flex items-center gap-2 hover:gap-3 hover:text-[#fff] hover:bg-[#634C9F] transition-all duration-300"
      >
        View All{" "}
        <svg
          width="14"
