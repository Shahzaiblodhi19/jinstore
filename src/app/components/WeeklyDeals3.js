          ...
          {deals.map((deal, index) => (
            ...
            >
              ...
              <div className="relative z-10 max-w-[71%] sm:max-w-[60%] lg:max-w-[45%]">
                <p className="text-[12px] sm:text-[12px] text-[#7C2D12] font-medium bg-[#FFEDD5] inline-block px-3 py-1 rounded-full">
                  {deal.tag}
                </p>
                <h3 className="text-[18px] sm:text-[15px] xl:text-[24px] font-bold text-[#111827] mt-1 sm:mt-2 leading-snug">
                  {deal.title}
                </h3>
